...
It's important to note that > Newton's method of approximation does not work if the slope of tangency is zero at the guess, nor does it identify if there's multiple roots
